...
/***/ function(module, exports) {
	...
	/***/function (module, exports) {
		...
		var BaseProvider = exports.BaseProvider = (function () {
			...
			_createClass(BaseProvider, [{
				key: 'requestForCode',
				value: function requestForCode() {
					throw new TypeError('not implemented');
				}
			}, {
				key: 'requestForAccessToken',
				value: function requestForAccessToken(code) {
					throw new TypeError('not implemented');
				}
			}, {
				key: 'requestForProfile',
				value: function requestForProfile(openid, accessToken) {
					throw new TypeError('not implemented');
				}
			}]);
		...
		var WeChatProvider = exports.WeChatProvider = (function (_BaseProvider) {
			_inherits(WeChatProvider, _BaseProvider);

			function WeChatProvider(config) {
				_classCallCheck(this, WeChatProvider);

				var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(WeChatProvider).call(this, config));
			...
			_createClass(WeChatProvider, [{
				key: 'requestForCode',
				value: function requestForCode() {
					var url = 'https://open.weixin.qq.com/connect/oauth2/authorize?' + ('appid=' + this.config.appid + '&') + ('redirect_uri=' + this.config.redirectUri + '&') + 'response_type=code&' + ('scope=' + (this.config.scope || 'snsapi_base') + '&') + ('state=' + (this.config.state || '')) + '#wechat_redirect';
					location.href = url;
				}
			}, {
				key: 'requestForAccessToken',
				value: (function () {
					...
					return function requestForAccessToken(_x) {
				...
				key: 'requestForProfile',
				value: (function () {
					var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(openid, accessToken) {
						var err, url, response;
							...
							while (1) {
								switch (_context2.prev = _context2.next) {
									case 0:
										...
										err = new TypeError('you need use scope: snsapi_userinfo');
					...
					return function requestForProfile(_x2, _x3) {
						return ref.apply(this, arguments);
					};
				})()
			}]);
		...
		var Passport = exports.Passport = (function () {
			function Passport(providers) {
			...
			_createClass(Passport, [{
				key: 'authenticate',
				value: (function () {
					var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(name, query) {
						var provider, tokens;
						return regeneratorRuntime.wrap(function _callee3$(_context3) {
							while (1) {
								switch (_context3.prev = _context3.next) {
									...
									case 9:
										_context3.next = 11;
										return provider.requestForAccessToken();
									...
									case 11:
										...
										_context3.next = 17;
										return provider.requestForProfile(this.payload.openid, this.payload.accessToken);

									case 17:
										this.payload.profile = _context3.sent;
